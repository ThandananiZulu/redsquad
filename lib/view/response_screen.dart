                      ...
                      Container(
                        ...
                        child: DropdownButtonFormField<String>(
                          decoration: InputDecoration(
                            labelText: 'Select Type Of Response:',
                          ),
                          value: dropdownValue,
                          onSaved: (String? value) {},
                          validator: (value) {
                            if (value == null || value.isEmpty) {
                              return 'A type of Response is required';
                            }
                            return null;
                          },
    ...
    for (int i = 0; i < claimsList.length; i++) {
      ...
      planDataWidgets.add(
        PlanTile(
          ...
          subtitle: 'Date of Response:  ${firstname} ${surname}',
          desc: ' ${cover}',
          status: 'Active',
          map: '',
          planID: planID,
        ...
        children: [
          Padding(
            ...
            child: Column(
              ...
              children: [
                _buildLabel("Description of Response:"),
                SizedBox(height: 8),
                _buildDescriptionTextField(widget.desc),
                SizedBox(height: 16.0),
                _buildLabel("Response Status:"),
                SizedBox(height: 8),
