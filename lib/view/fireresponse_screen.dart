...
class FireresponseScreen extends StatefulWidget {
  const FireresponseScreen({Key? key}) : super(key: key);

  @override
  State<FireresponseScreen> createState() => _FireresponseScreenState();
}

class _FireresponseScreenState extends State<FireresponseScreen> {
  int index = 0;
